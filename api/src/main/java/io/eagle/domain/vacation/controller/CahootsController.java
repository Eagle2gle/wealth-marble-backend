...
public class CahootsController {
    ...
    public ApiResponse getCahootsDetailInfo(@PathVariable("cahootsId") Long cahootsId, Long userId){
        return ApiResponse.createSuccess(cahootsService.getDetail(cahootsId, userId));
    }
